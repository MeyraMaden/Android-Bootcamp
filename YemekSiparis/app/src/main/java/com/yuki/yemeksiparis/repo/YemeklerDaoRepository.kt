package com.yuki.yemeksiparis.repo
...
import com.yuki.yemeksiparis.entity.YemekSepetCevap
import com.yuki.yemeksiparis.entity.Yemekler
import com.yuki.yemeksiparis.entity.YemeklerCevap
import com.yuki.yemeksiparis.fragment.AnasayfaFragment
import com.yuki.yemeksiparis.fragment.YemekDetayFragment
import com.yuki.yemeksiparis.retrofit.ApiUtils
import com.yuki.yemeksiparis.retrofit.YemeklerDaoInterface
...
class YemeklerDaoRepository {
    ...
    fun yemekAciklama(yemek_adi: String, tasarim : FragmentYemekDetayBinding){
        when (yemek_adi) {
            ...
            "Izgara Tavuk" -> tasarim.textViewYemekAciklama.text = "Sporcu beslenme düzeninde ve diyet listelerinde önemli bir yeri olan ızgara tavuk NomNom kalitesiyle ayağınıza kadar gelmektedir."
            ...
            "Pizza" -> tasarim.textViewYemekAciklama.text = "Her zevke hitap eden leziz pizzalar, tavuklar, tatlılar ve ekstra lezzetler NomNom'da"
            ...
            "Sütlaç" -> tasarim.textViewYemekAciklama.text = "Evde yaptığınız Sütlacı nasıl yaparsınız? Pirinç, Süt, Pirinç Unu ve Şeker. İşte NomNom Sütlacının içinde de tam olarak ve sadece bunlar var! Gluten , Glikoz-Fruktoz şurubu ve Koruyucu katkı içermez."
